...
//			$html = $request;
			...
			$html .= "<br><img width=60 height=75 src='".$image."' />";
			$html .= "<br>".$author;
	
	    		//$html .= "<br><br>Buyback Price: $".$buybackPrice['original']."<br>Buyback Price: $".$buybackPrice['price']."<br><br>Amazon Price: ".$amazonPrice."<br>Lowest New Price: ".$lowNewPrice."<br>Lowest Used Price: ".$lowUsedPrice."<br>Weight: ".$weight." lbs.<br>Title: ".$title."<br>OUR PRICE: ";
	...
	*/
	...
	/*		if($ourPrice2 >= 25)
			...
			else if( floatval($lowNewPrice) < floatval($buybackPrice['original']))
			{
				$status = 1;
			}
			else if (floatval($lowNewPrice) <= (floatval($lowUsedPrice)*1.10))
			{
				$status = 2;
			}
			else if(floatval($priceList['usedPrice']) < floatval($lowUsedPrice))
			{
				$status = 3;
			}
			else
...
<div id = "page">
	...
	<div id = "content">
	<form id = "isbnForm"  name = "form" onSubmit = "return xajax_addBook();">
