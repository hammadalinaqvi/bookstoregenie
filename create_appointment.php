...
<html>
	<head>
		...
		<script src="script/time-picker.js" type = "text/javascript"></script>
		<link rel = "stylesheet" href = "style/main-good-ui.css" />
		...
		if( navigator.userAgent.match(/Android/i) ||
			 ...
			 window.location = "http://www.bookstoregenie.com/create_appointment_mobile.html";
		}
		var checked = false;
		function College(name, dbName, isbn, link){
			...
			window.onload = function(){
				...
				if ($("#search").val() !=  ""){
					...
					$("html, body").animate({
						scrollTop: $("#secondaryForm").offset().top
					}, 600);
					setLabels();
				}
				$("#secondaryForm").ajaxForm({
					...
					"success" : function(response){
						$.loading(false);
						$("#popupTitle").html("Appointment created");
						$("#contactArea").html("Thank you, Your appointment has been created succesfully. You will receive a confirmation email from one of our representatives soon.");
						centerPopup();
						loadPopup();
	...
	<body>
		...
		<div id = "wrapper">
			...
			<form class = "jqtransform"	style = "display:none;" id = "secondaryForm" action = "schedule_appointment.php" method = "POST">
					<h3 id = "formTitle">Appointment Information</h3>
					<p id = 'formInfo'> Please fill in the information below so that we can schedule your appointment </p>
					<div id = "formData">
						...
						<div class = "rowElem"><label for = "date">Date: </label><input class = "formInput" id = "date" type = "text" name = "date" value = ""></input></div>
						<div class = "rowElem"><label for = "firstName">Name: </label><input class = "formInput" type = "text" name = "name" value = "" ></input></div>
					...
					<div class = "rowElem"><input id = 'submit_btn' type = "submit" value = "Create Appointment"></input></div>
				</form>
			</div>
			<div id = "footer">
		 ...
		 <div id="popupContact">  
			...
			<h1 id = "popupTitle">Appointment Created</h1>  
			<p id="contactArea">  
