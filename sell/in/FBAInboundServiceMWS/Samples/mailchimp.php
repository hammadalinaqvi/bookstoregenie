...
$query = mysql_query('SELECT * FROM book_shipment WHERE transaction_status = "complete" && status="mail"');
...
//$query_update = mysql_query("UPDATE book_shipment SET to_name='$shipToName', to_addressLine1='$shipToAdd1', to_addressline2='$shipToAdd2', to_city='$shipToCity', to_state='$shipToState', to_country='$shipToCountry', to_postalCode='$shipToPostCode', destination_code='$DestinationFulfillmentCenterId', fulfilment_network_SKU='$fulfillmentNetworkSKU', label_type='$lableType', shipment_id='$shipment_id', status='shipped', transaction_status='complete' WHERE SKU='$item_SKU'");
...
$FromName = $from_name;
$FromAddress2 = $from_add1;
$FromCity = $from_city;
$FromState = $from_state;
$FromZip5 = $from_postCode;

$ToName = $shipToName;
$ToAddress2 = $shipToAdd1;
$ToCity = $shipToCity;
$ToState = $shipToState;
$weightOunces = 8;
...
$content_Outer_USPS_Slip = $USPSLabel;
...
$content_Outer_USPS_Slip = base64_decode($content_Outer_USPS_Slip);
/*echo '<br /><br />********************************************* DECODED ************************************************************';
print_r($content_Outer_USPS_Slip);
echo '<br /><br />********************************************* DECODED ************************************************************';
*/
...
$from = array('info@bookstoregenie.com' => 'Bookstore Genie Inc.');
