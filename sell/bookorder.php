	...
	?>
				...
				<script>
                 ...
                 <script>
                  ...
                  <input class="span5" type="text" id="PhoneNo" name="phone" placeholder="Phone Number">
                  <script>
					var PhoneNo = new LiveValidation( 'PhoneNo', {onlyOnSubmit: true } );
					PhoneNo.add( Validate.Presence,{ failureMessage: "Required" } );
                </script>
				  <input class="span5" type="text" id="fullName" name="fullname" placeholder="Full name">
                  <script>
					var fullName = new LiveValidation( 'fullName', {onlyOnSubmit: true } );
                 ...
                 <input class="span5" type="text" id="contactEmail" name="contactEmail" placeholder="Contact Email">
				  ...
				  <input class="span2 field-push-right" type="text" maxlength="2"  id="state" name="state" placeholder="State Code">
                   <script>
					var state = new LiveValidation( 'state',{onlyOnSubmit: true }  );
					state.add( Validate.Presence,{ failureMessage: "Required" } );
					state.add( Validate.Length, { is: 2 , wrongLengthMessage: "2 Characters only!"});
                </script>
