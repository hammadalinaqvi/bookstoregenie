...
*/
    ...
    */
    function AutoComplete_Create (id, data)
    {
        __AutoComplete[id] = {'data':data,
                              ...
                              'dropdown':null,
                              'highlighted':null,
							  'container':document.getElementById('searchContainer')}; // this is specific to this page change it for any other page using autocomplete
    ...
    */
    function AutoComplete_CreateDropdown(id)
    {
		...
		__AutoComplete[id]['container'].appendChild(__AutoComplete[id]['dropdown']);
    ...
    */
    function AutoComplete_ShowDropdown(id)
    {
		...
		if (value.substr(0, 4).toUpperCase() == "THE "){
			offset = 4;
		}
		if (value != ''){
			for (i=0; i<__AutoComplete[id]['data'].length; i++) {
				if (value.substr(offset).toUpperCase() == __AutoComplete[id]['data'][i].substr(0, value.length - offset).toUpperCase()) {
					toDisplay[toDisplay.length] = __AutoComplete[id]['data'][i];
				}
			}
		}
		
		toDisplay[toDisplay.length] = "Can't find your University?";
        ...
        */
		...
		__AutoComplete[id]['dropdown'].style.left = 216;
        __AutoComplete[id]['dropdown'].style.top  = 89;
