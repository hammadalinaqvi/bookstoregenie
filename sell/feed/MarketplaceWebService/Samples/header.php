...
{
require_once "includes/Book_sell.php";
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#"><img src="images/logo.png"/></a>
            <ul class="nav">
              <li><a href="#">Rent</a></li>
              <li><a href="sellnow.php">Sell</a></li>
            </ul>
            <form class="form-search pull-left" onSubmit="var isbn=document.getElementById('inSearchText').value;  xajax_reloadPage(isbn); return false;">
						  <div class="input-append">
						    <input type="text" class="span3 search-query top-field" id="inSearchText"placeholder="Enter your ISBN number(s)"  onClick="if(this.value=='Add more books') this.value='';">
						...
						<div class="span1 pull-left">
							...
							<button type="submit" class="btn btn-medium btn-block bsg-btn pull-left top-field" href="cart" title="Send money"><i class="icon-shopping-cart"></i></button>
						</div>
						<div class="dropdown droppy">
						  <a class="dropdown-toggle" data-toggle="dropdown" href="#" href="#"><img src="images/dropdown.png"/></a>
						  <ul class="pull-right dropdown-menu" role="menu" aria-labelledby="dLabel">
						    <li><a tabindex="-1" href="#">Rent now</a></li>
						    <li><a tabindex="-1" href="#">About us</a></li>
						    <li><a tabindex="-1" href="#">Trust the Genie</a></li>
						    <li><a tabindex="-1" href="#">Be a Genie</a></li>
						    <li class="divider"></li>
