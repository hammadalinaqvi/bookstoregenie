...
// --------------------- QUERY TO ADD THE ROCORD IN BOOK_ORDER --------------------------------------		 
	...
	$query_book_order = mysql_query("INSERT INTO book_order (from_name, from_email, total_books, total_order_price, email_opened_status, created_at, updated_at) VALUES ('".$fromName."', '".$fromEmail."', '".$total_books."', '".$total_book_cost."', '0', '".date('Y-m-d H:i:s')."', '".date('Y-m-d H:i:s')."')");
...
?>
    ...
    <div class="container">
        <div class="span6 offset2 white_well"> 
            ...
            <br/><br/>
            <div class="blue_well" align="left">
            Please wait for an email from Bookstore Genie Team containing you <strong>"Shipment Label Slip"</strong>.
            <br />
            <br />
