 ...
 */
$notificationSubject = 'File upload form test';
 ...
 * Validators: Required
 */
$name = new iPhorm_Element('name');             // Create the name element
 ...
 */
$email = new iPhorm_Element('email');               // Create the email element
 ...
 * Validators: Required
 */
$message = new iPhorm_Element('message');             // Create the message element
...
$upload->getFileUploadValidator()->setRequired(true)->setMaximumFileSize(10485760); // Required and 10MB file size limit
...
$uploads->getFileUploadValidator()
        ->setRequired(true)                                         // Set element required
        ->setRequiredCount(2)                                       // Require at least 2 files
        ->setAllowedExtensions(array('gif', 'jpeg', 'jpg', 'png'))  // Limit by file extension
        ->setMaximumFileSize(1048576);                              // Set maximum file size to 10MB
