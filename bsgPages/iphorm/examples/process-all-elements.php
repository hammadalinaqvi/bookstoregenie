 ...
 */
$notificationSubject = 'All elements form test';
 ...
 * Validators: Required
 */
$text = new iPhorm_Element('text_input');             // Create the text_input element
 ...
 * Validators: Required
 */
$singleSelect = new iPhorm_Element('single_select');       // Create the single_select element
 ...
 * Validators: Required
 */
$multiSelect = new iPhorm_Element('multi_select[]');      // Create the multi_select element
 ...
 * Validators: Required
 */
$singleCheckbox = new iPhorm_Element('single_checkbox');     // Create the single_checkbox element
 ...
 * Validators: Required
 */
$multiCheckbox = new iPhorm_Element('multi_checkbox[]');     // Create the multi_checkbox[] element
 ...
 * Validators: Required
 */
$radioButton = new iPhorm_Element('radio_button');         // Create the radio_button element
 ...
 * Validators: Required
 */
$textarea = new iPhorm_Element('textarea_input');       // Create the textarea_input element
