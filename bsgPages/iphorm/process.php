 ...
 * Validators: Required
 */
$name = new iPhorm_Element('name', 'Name');     // Create the name element
 ...
 */
$email = new iPhorm_Element('email', 'Email address');  // Create the email element
 ...
 * Validators: (None)
 */
$phone = new iPhorm_Element('phone', 'Phone number');   // Create the phone element
 ...
 * Validators: (None)
 */
$subject = new iPhorm_Element('subject', 'Subject');  // Create the subject element
 ...
 * Validators: Required
 */
$message = new iPhorm_Element('message', 'Message');  // Create the message element
 ...
 */
$captcha = new iPhorm_Element('type_the_word', 'Type the word');    // Create the type_the_word (captcha) element
...
$captcha->addValidator('identical', array('token' => 'light'));     // Add Identical validator, the value must match the word light
$captcha->setIsHidden(true);                                        // The value should be hidden in the notification email
