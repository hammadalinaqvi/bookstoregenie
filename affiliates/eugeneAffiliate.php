<?php
	...
	function buy($college,$org,$contactPerson,$email,$number,$paypal,$code)
	{
		...
		else
		{
			...
			$query = "insert into jteplitz_bookstore.discounts (Name, Type,CouponCreator) values ('$code',$highest,'eugene')";	
...
<div id = "page">
	<div id = "header">
		<h1>Just for Eugene - Please add lots of organizations - Love, Farhan</h1>
	</div>
	<div id = "content">
