<?php
	...
	function buy($isbn,$amazonPrice,$lowNewPrice,$lowUsedPrice,$weight,$title, $ourPrice2, $weird, $address)
	{
	...
	function addBook($isbn)
	{
		...
		$html .= "CampusBooks Used Price: $".$priceList['usedPrice']."  Merchant: ".$priceList['usedMerchant']."<br>CampusBooks New Price: $".$priceList['newPrice']."  Merchant: ".$priceList['newMerchant']."<br>Campusbooks Rent Price: $".$priceList['rentPrice']."  Merchant: ".$priceList['rentMerchant']."<br>Chegg Rent Price: $".$priceList['cheggRent'];

    		$html .= "<br><br>Buyback Price Original: $".$buybackPrice['original']."<br>Buyback Price: $".$buybackPrice['price']."<br><br>Amazon Price: ".$amazonPrice."<br>Lowest New Price: ".$lowNewPrice."<br>Lowest Used Price: ".
		...
		else
		{
    		...
    		$html .= "<br><input type = \"text\" id = \"email_ad\" name = \"email_ad\" ></input><br><input type='submit' value='BUY' onclick='var address=document.getElementById(\"email_ad\").value;alert(address);xajax_buy(\"$isbn\",$amazonPrice,$lowNewPrice,$lowUsedPrice,$weight,\"$title\",$ourPrice2, $weird,\"address\");'>"."<br><br><input type='submit' value='DONT BUY' onclick='xajax_noBuy();'>";
