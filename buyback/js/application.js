...
// This file is automatically included by javascript_include_tag :defaults
	...
	function updateTotal()
	{
		...
		for(i = 0 ; i < myAsins.length; i++){
			...
			document.getElementById("Subtotal"+asin).innerHTML = "$"+Math.round(eval(subtotal)*100)/100;
		...
		document.getElementById("totalPrice1").innerHTML = "$"+Math.round(priceOverall*100)/100;
		...
		document.getElementById("totalPrice").innerHTML = "$"+Math.round(priceOverall*100)/100;
