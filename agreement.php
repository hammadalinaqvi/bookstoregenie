...
<link rel="stylesheet" type="text/css" href="contact-form/css/inline.css" />
...
<div id="wrapper">
  <div id="header">
    <div class="container_12">
      <div class="grid_3 alpha"> <a href="./index.html" title="Bookstore Genie" id="logo">Bookstore Genie</a> </div>
      <div class="grid_9 omega">
        <ul class="menu sf-menu">
          <li><a href="./about.html">About Us</a></li>
          <li class="active"><a href="./rentbook.php">Rent Now</a></li>
  ...
  <div id="icon-widgets">
    <ul class="icon-menu">
      <li class="social-icons"><a href="#">Social links</a>
        <div id="social-icons">
          <div class="inner"> <a target="_blank" href="#" rel="nofollow"><img title="Follow us on Twitter" alt="Twitter" src="./images/social_icons/twitter.png" /></a> <a target="_blank" href="#" rel="nofollow"><img title="Follow us on Facebook" alt="Facebook" src="./images/social_icons/facebook.png" /></a>
            <div class="clear"></div>
          </div>
        </div>
      </li>
  ...
  <div id="slideshow">
    <div class="container_12">
      <div class="grid_12 alpha omega">
        <h2 class="page-title">Contract Agreement </h2>
      </div>
    </div>
    <!-- Container End -->
  ...
  <div id="container">
    ...
    <div class="container_12">
      <div class="grid_8 alpha">
        <div class="breadcrumb"> <a href="http://www.bookstoregenie.com" title="Homepage">Homepage</a> &raquo <a href="http://www.bookstoregenie.com/bsgPages/beAgenie.html" title="Homepage">Be a Genie</a> &raquo Contract Agreement</div>
      </div>
      <div class="grid_4 omega"> <span id="current-date"></span> </div>
      <div class="clear"></div>
      <div class="separator"></div>
      <div class="main-content aggrement">
        <br>
		
		<h1 class="centerThat"><span>Bookstore Genie&trade; Independent Contractor Agreement</span></h1>
		...
		<a title="BookstoreGenie™ Contract Agreement" href="#inline1" id="various1"><img src="images/contract.jpg"></a>
		
		<div style="display: none;">
				<textarea style="width:601px;height:600px;overflow:scroll;font-size: 10pt;" cols="80" rows="100" id="inline1">		
...
EXHIBIT A &ndash; DUTIES, TERM, AND COMPENSATION
...
0 - $7,500               				10%						$0 - 750
$7,501 &ndash; 10,000				11%						$825.11 &ndash; 1,100
$10,001 &ndash; 15,000            		12.5%          				$1250.13 &ndash; 1,875
$15,001 +					15%						$2,250.15 +
...
IN WITNESS WHEREOF the undersigned have executed this Agreement as of the day and year first written above on Page 1 of 1.  The parties hereto agree that facsimile signatures shall be as effective as if originals.	
           ...
           <div class="line"></div>
            ...
            <form action="" name="agreement" method="post">

            <p class="centerThat">School served: <input type="text" value="" size="40" class="green" id="textfield" name="ic_schoolname"></p>
                  ...
                  that the digital signature below is enforceable as a facsimile signature.</p>Check the following box to indicate your agreement to the terms of the contract: <input type="checkbox" id="checkbox" name="ic_check" class="checkbox"></h2>
                      
                
                <p class="centerThat">Independent Contractor (Your full name): <input type="text" value="" class="orange" name="ic_name_check"></p>
			               ...
			               <div class="iphorm-container clearfix">
		                        ...
		                        <div class="element-wrapper name-element-wrapper clearfix">
		                            ...
		                            <div class="input-wrapper name-input-wrapper">
		                                <input type="text" name="name" id="firstname" class="name-element">
		                            </div>
		                        </div>
		                        <!-- End Name element -->
		                        <!-- Begin Name element -->
		                        <div class="element-wrapper name-element-wrapper clearfix">
		                            ...
		                            <div class="input-wrapper name-input-wrapper">
		                                <input type="text" name="name" id="name" class="name-element">
		                            </div>
		                        </div>
		                        <!-- End Name element -->
		                        <!-- Begin Email element -->
		                        <div class="element-wrapper email-element-wrapper clearfix">
		                            ...
		                            <div class="input-wrapper email-input-wrapper">
		                                <input type="text" title="We will never send you spam, we value your privacy as much as our own" name="email" id="email" class="email-element iphorm-tooltip">
		                            </div>
		                        </div>
		                        <!-- End Email element -->
		                        ...
		                        <div class="element-wrapper email-element-wrapper clearfix">
		                            ...
		                            <div class="input-wrapper email-input-wrapper">
		                                <input type="text" title="We will never send you spam, we value your privacy as much as our own" name="Paypalemail" id="ppemail" class="email-element iphorm-tooltip">
		                            </div>
		                        </div>
		                        <!-- End Email element -->
		                        <!-- Begin Phone element -->
		                        <div class="element-wrapper phone-element-wrapper clearfix">
		                            ...
		                            <div class="input-wrapper phone-input-wrapper">
		                                <input type="text" title="We will only use your phone number to contact you regarding your enquiry" name="phone" id="phone" class="phone-element iphorm-tooltip">
		                            </div>
		                        </div>
		                        <!-- End Phone element -->
		                        <!-- Begin Name element -->
		                        <div class="element-wrapper name-element-wrapper clearfix">
		                            ...
		                            <div class="input-wrapper name-input-wrapper">
		                                <input type="text" name="name" id="code" class="name-element">
		                            </div>
		                        </div>
		                        <!-- End Name element -->
		                        ...
		                        <div class="addressContainer">
			                        ...
			                        <div class="element-wrapper address-element-wrapper clearfix">
			                            ...
			                            <div class="input-wrapper name-input-wrapper">
			                                <input type="text" name="address" id="address" class="address-element">
			                            </div>
			                        </div>
			                        <!-- End Address element -->
			                        <!-- Begin Address element -->
			                        <div class="element-wrapper city-element-wrapper clearfix">
			                            ...
			                            <div class="input-wrapper city-input-wrapper">
			                                <input type="text" name="city" id="city" class="city-element">
			                            </div>
			                        </div>
			                        <!-- End Address element -->
			                        <!-- Begin Zip element -->
			                        <div class="element-wrapper zipcode-element-wrapper clearfix">
			                            ...
			                            <div class="input-wrapper zipcode-input-wrapper">
			                                <input type="text" name="zip" id="zip" class="zipcode-element">
			                            </div>
			                        </div>
			                        <!-- End Zip element -->
			                        <!-- Begin State element -->
			        ...
			        <div class="iphorm-inner">
			               ...
			               <div class="iphorm-container clearfix">
		                        ...
		                        <div class="element-wrapper name-element-wrapper clearfix">
		                            ...
		                            <div class="input-wrapper name-input-wrapper">
		                                <input type="text" name="name" id="ssn" class="name-element">
		                            </div>
		                        </div>
		                        <!-- End Name element -->
		                        <!-- Begin Submit button -->
		                        <div class="button-wrapper submit-button-wrapper clearfix">
		                            ...
		                            <div class="button-input-wrapper submit-button-input-wrapper">
		                                <input type="submit" onclick="var agreement = 0;
		                                ...
		                                return false;
		                                " value="Submit Application" name="contact" class="submit-element">
      ...
      <div class="container_12">
        ...
        <div class="grid_3 omega">
          <ul class="social-connect">
            <li class="tweet"> <a href="http://twitter.com/share" class="twitter-share-button" data-text="" data-count="horizontal" data-via="BookstoreGenie">Tweet</a>
